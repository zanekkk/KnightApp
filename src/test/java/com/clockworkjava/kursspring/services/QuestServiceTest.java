...
////        Quest q1 = new Quest("Test questu 1");
////        Quest q2 = new Quest("Test questu 2");
////        Quest q3 = new Quest("Test questu 3");
//
//        q2.setStarted(true);
//
//        quests.add(q1);
...
//
//        assertEquals("Size od returned quest", 2 ,allNotStartedQuests.size());
